...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PGPLOT_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("b11e30b1-63be-5002-9df0-88ee0fe906ff"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PGPLOT", artifacts_toml) for e in artifacts["PGPLOT"]]
...
if best_platform === nothing
    @debug("Unable to load PGPLOT; unsupported platform $(triplet(platform_key_abi()))")
else
